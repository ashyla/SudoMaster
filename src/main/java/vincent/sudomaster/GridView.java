...
import vincent.sudomaster.MouvCase;
import vincent.sudomaster.SudokuGrid;
...
public class GridView extends View{
    ...
    LinkedList<vincent.sudomaster.Case> cases;
    ...
    public GridView(Context context, AttributeSet attrs){
        super(context,attrs);
        cases = new LinkedList<vincent.sudomaster.Case>();
    ...
    public int getCurrentDone(){
        long nbNumberIn = 0;
        long nbEmptyCase = 0;
        for (vincent.sudomaster.Case caseGrid : cases){
